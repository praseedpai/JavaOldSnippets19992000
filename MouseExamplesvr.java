...
public class MouseExamplesvr extends JFrame implements ActionListener , MouseListener
{
   ...
   public  MouseExamplesvr () 
   {
     super("JAVA 2D DEMO");
     //
     //mnu.addActionListener(this);
     //JMenu     mnus = new JMenu("File");
	JMenuItem  mnus = new JMenu("File");
  ...
  {
    MouseExamplesvr  st = new MouseExamplesvr(); 
